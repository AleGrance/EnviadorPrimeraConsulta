...
module.exports = (app) => {
  const Historicos_primera_consulta = app.db.models.Historicos_primera_consulta;
  ...
  async function cantidadEnviados() {
    ...
    historicoObj.cant_enviados = await Primera_consulta.count({
      where: {
        [Op.and]: [
          { estado_envio: 1 },
          {
    ...
    historicoObj.cant_no_enviados = await Primera_consulta.count({
      where: {
        [Op.and]: [
    ...
    Historicos_primera_consulta.create(historicoObj)
      .then((result) => {
  ...
  app
    ...
    .post((req, res) => {
      Historicos_primera_consulta.create(req.body)
        .then((result) => res.json(result))
