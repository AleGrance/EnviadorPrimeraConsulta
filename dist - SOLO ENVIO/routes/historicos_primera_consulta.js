...
module.exports = function (app) {
  var Historicos_primera_consulta = app.db.models.Historicos_primera_consulta;
  ...
  cron.schedule("00 14 * * 2-6", function () {
  ...
  function cantidadEnviados() {
    return _cantidadEnviados.apply(this, arguments);
  }
  /**
   *
   *  METODOS
  ...
  function _cantidadEnviados() {
    _cantidadEnviados = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var fechaHoy;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 4:
              ...
              return Primera_consulta.count({
                where: _defineProperty({}, Op.and, [{
                  estado_envio: _defineProperty({}, Op.ne, 1)
                }, {
                  updatedAt: _defineProperty({}, Op.between, [fechaHoy + " 00:00:00", fechaHoy + " 23:59:59"])
                }])
              });
            ...
            case 7:
              ...
              Historicos_primera_consulta.create(historicoObj).then(function (result) {
  ...
  app.route("/api/historicosPrimeraConsulta").get(function (req, res) {
    Historicos_primera_consulta.findAll().then(function (result) {
    ...
    Historicos_primera_consulta.create(req.body).then(function (result) {
      return res.json(result);
    })["catch"](function (error) {
  ...
  app.route("/api/historicosPrimeraConsultaFecha").post(function (req, res) {
